...
2. Verify only the changed pages in `build/`
3. Run linkcheck if links were added/updated
...
3. Build docs with `sphinx-build --write-all src build`
4. Publish built site
